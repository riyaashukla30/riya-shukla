      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white text-[18px] font-bold cursor-pointer flex">
            Riya&nbsp;<span className="sm:block hidden">| Software Engineer</span>
          </p>
        </Link>
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10">
          ...
          <li>
            <a
              ...
              className="bg-tertiary hover:bg-[#915eff] transition-colors text-white text-[14px] font-semibold px-4 py-2 rounded-full"
            >
              Resume
            </a>
          </li>
